            ...
            <div class="div-main-title">Наши услуги</div>
                <div class="div-cards-services">
                    ...
                    <div class="div-card">Массаж шея+спина
                        ...
                        <p class="description">Прорабатывает самые глубокие мышечные зажимы в области спины и шеи, снимает болевые ощущения и напряжение, благотворно влияет на осанку</p>                        
                    </div>
                    ...
                    <div class="div-card">Массаж ног
                        ...
                        <p class="description">Способствует улучшению кровообращения, нормализации обмена веществ, активизации иммунных механизмов, избавляет от эффекта "усталых ног"</p>
                    </div>
                    <div class="div-card">Маслянный массаж
                        <img class="img-serveces" src="images/spa_pict_5.png" alt="Маслянный массаж">
                        <p class="description">Снимает нервное напряжение, дарит расслабление и легкий лимфодренажный эффект</p>
                    </div>
                    <div class="div-card">Медовый массаж
                        <img class="img-serveces" src="images/spa_pict_6.png" alt="ММедовый массаж">
                        <p class="description">Позволяет очистить кожу от шлаков и токсинов, снять отечность, усилить интенсивность оттока скапливающейся жидкости</p>
                    </div>
                    <div class="div-card">Stone массаж
                        <img class="img-serveces" src="images/spa_pict_7.png" alt="Stone массаж">
                        <p class="description">Массаж выполняется горячими нефритовыми камнями, оказывает глубокий расслабляющий эффект, регулирует работу вегетативной нервной системы</p>
                    </div>
                    <div class="div-card">Скрабирование
                        <img class="img-serveces" src="images/spa_pict_8.png" alt="Скрабирование">
                        <p class="description">Процедура очищения и омоложения кожи, отшелушивание, глубокое очищение, массаж, тонизирование и восстановление эпидермиса</p>
                    </div>
                    <div class="div-card">Обертование
                        <img class="img-serveces" src="images/spa_pict_9.png" alt="Обертование">
                        <p class="description">Создаёт парниковый эффект, который способствует проникновению активных веществ в кожу</p>
                    </div>
                </div>
        </section>
